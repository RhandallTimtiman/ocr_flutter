...
import 'package:ml_flutter/ml_text_recognizer.dart';
import 'package:ml_flutter/recognition_response.dart';
    ...
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () async {
          ...
          final recognizedText = await _recognizer.processImage(photo!.path);
